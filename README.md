...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k0t0yys.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k0t0yys.containers.anotherwebservice.com/
...
```
git clone git@github.com:alidoom2010/container-k0t0yys.git
cd container-k0t0yys
```
...
```
docker attach container-k0t0yys
```
